...
computing the area of a regular polygon is Area = (n*(s*s))/4 *tan(PI/n).
...
public class Zadatak2 {
	...
	public static void main(String[] args) {
		// creating 3 new objects regularPolygons and its properties
		...
		// go for 0 to 3 polygon and print each one and its area and perimeter
		for (int i = 0; i < 3; i++) {

			System.out.printf("Polygon %d area = %.3f perimeter = %.3f\n", i,
					regularPolygons[i].getArea(),
